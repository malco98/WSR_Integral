		...
		<tbody>
			...
			<tr>
				<td>
					...
					<p>Bienvenido a WSR Integral.</p>
					<p>Ahora puedes ver tus estados en los proyectos.</p>
					...
					<a href="<?= BASE_URL; ?>" target="_blank" class="x_button_link x_link_blue">Inicia ahora</a>
