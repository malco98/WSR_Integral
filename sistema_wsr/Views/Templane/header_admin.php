...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <meta name="description" content=" Sistema WSR">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Pepe el Pinguino">
  ...
  <div id="divLoading" >
    ...
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?= base_url(); ?>/dashboard">WSR</a>
